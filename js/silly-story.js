...
function result() {
    ...
    if (customName.value !== ""){ //is not empty
        newStory = newStory.replace("Bob", customName.value); //input value
    }
    ...
    if (document.getElementById("metric").checked) {
        ...
        newStory = newStory.replace("300 pounds", weight.toString() + "Kg");
        ...
        newStory = newStory.replace("94 farenheit", temp.toString() + "C");
    }
